 ...
 * If it has a MethodExecutor instance associated to it, 
 * then its MethodExecutor.execute() will be invoked instead<br>
 * <br>
...
public class MenuElement{
     ...
     * 
     * @param executor An instance of MethodExecutor class that will get its execute()
     *      method invoked
     */
