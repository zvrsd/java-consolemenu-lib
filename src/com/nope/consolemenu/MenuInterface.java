 ...
 * element.add(new MenuElement("SubMenu");
 * menu.setRootElement(element);<br>
 * <br>
 * Then you can run your menu like this :<br>
 * menu.displayMenu(); // Displays the menu at the currently selected element<br>
...
public class MenuInterface {
    ...
    /**
 	 * Selects a MenuElement from the user input's string
     * and executes something if has to
     * 
    ...
    /**
     * @deprecated
     * @see selectElement(String choice)
     * @param choice 
     */
